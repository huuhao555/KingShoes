...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Admin<b> KING SHOES</b></a>
            <small>Trang chủ bán giày Nhóm 4</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="process.php">
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="sign-up.html">Đăng ký tại đây!</a>
                        </div>
